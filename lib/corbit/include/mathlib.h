...
#include "corbit_const.h"
    ...
    bool interpolation_Lagrange_Barycentric(double *x, double *y, int n, double xt, double *yt);
    void interpolation_multip_dimension( int n,  int m, double *x, double *y, double xt, double *yt, double *yt_derivative);
    ...
    void matrixMultiply_v1(int rA, int cA, double *A, int cB, double *B, double *C, int cA_max, int cB_max);
    ...
    void crossproduct(int m, int n,  double A[],  double B[], double C[]);
    double dotproduct(int m, int n,  double A[],  double B[]);
    ...
    void matrixSymmetrize(int r, int max_r, double *m, double *t);
    int matrix_zero_check(double *A, int n, int N);
    /* matrix inversion */
    int ludcmp(double *A, int nn,  int n, int *indx, double *d);
    void lubksb( double *A, int nn, int n,  int *indx, double *b);
    int matinv(double *A, int nn, int n);
    int solve_lsq(double *A, double *y,  int n,  int m, double *x, double *Q);
    int solve_lsq_normal(double *BTWB, double *BTWL, int n, double *x, double *Q);
    double get_mean(double *x, int n, double threshold);
    double get_std(double *x,  int n, double threshold);
    double get_rms(double *x,  int n, double threshold);
    double get_min(double *x,  int n, double threshold);
    double get_max(double *x,  int n, double threshold);
