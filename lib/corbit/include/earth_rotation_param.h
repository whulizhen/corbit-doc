...
#define NUM_EOP_INTERP 3
    ...
    {
        char type;       /**<  "final" of "prediction", 'F' for final, 'P' for prediction, 'C' for interpolated, 'U' for uplink */
    ...
    void load_eops_uplink(int neop, double *eop_data_uplink, EOPREC *ptr_eop_store);
