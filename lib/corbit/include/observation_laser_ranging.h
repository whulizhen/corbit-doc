...
/**
 * @file observation_laser_ranging.h
 * @brief Declarations of laser ranging observations
 * @details
 * @author Dr. Zhen Li
 * @version 0.0.1
 * @date 2023.12.25
 * @note this file includes all the functions for laser ranging observation
...
#ifndef _OBSERVATION_LASER_RANGING_H_
#define _OBSERVATION_LASER_RANGING_H_
...
#define NA_VALUEF (-1.0e30)
  ...
  int readi(char *str, int *ival);
  int readd(char *str, double *dval);
  int readld(char *str, long double *ldval);
  int isna(char *str);
  void remove_blanks(char *str, int slen);
