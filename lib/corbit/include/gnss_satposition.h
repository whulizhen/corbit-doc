...
#ifndef EMBED
#include <stdio.h>
#define MAXEPOCH_EPH_PRE 8640
#define MAXEPOCH_CLK_PRE 8640
#define MAXEPOCH_EPH_BRDC 100
...
#include "common_function.h"
	...
	typedef struct _EPHBRDC_NOW_
	{
		...
		EPHREC_BDS* eph_brdc_bds_now[MAXPRNBDS + 1]; /**< pointers for broadcast ephemeris for GPS satellites */
		EPHREC_GAL* eph_brdc_gal_now[MAXPRNGAL + 1]; /**< pointers for broadcast ephemeris for GPS satellites */
		EPHREC_GLO* eph_brdc_glo_now[MAXPRNGLO + 1]; /**< pointers for broadcast ephemeris for GPS satellites */
	} EPHBRDC_NOW;
